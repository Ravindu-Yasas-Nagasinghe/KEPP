...
def get_args(description='whl'):
    ...
    parser.add_argument('--observation_dim',
                        ...
                        default=1536,
                        help='')
    parser.add_argument('--class_dim_graph',
                        type=int,
                        default=105, ####### modify according to the dataset.
                        help='')
    parser.add_argument('--class_dim_llama',
                        type=int,
                        default=105, ####### modify according to the dataset.
                        help='')
    parser.add_argument('--num_seq_PKG',
                        type=int,
                        default=2, ####### modify according to the dataset.
                        help='')
    parser.add_argument('--num_seq_LLM',
                        type=int,
                        default=2, ####### modify according to the dataset.
                        help='')
