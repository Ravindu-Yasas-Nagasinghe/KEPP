...
def main_worker(gpu, ngpus_per_node, args):
    ...
    checkpoint_ = torch.load("/home/ravindu.nagasinghe/GithubCodes/PDPP/PDPP/save_max_mlp/epoch0120.pth.tar",
    ...
    for i in range(len(test_dataset)):
        ...
        if event_class_id == vid_names['task_id']:
            correct += 1
            #print('event class:', event_class_id, '    task_id:', vid_names['task_id'] )
    ...
    data_name = "/l/users/ravindu.nagasinghe/datasets/PDPP/CrossTask_assets/trained_mlp/task_class.json"
